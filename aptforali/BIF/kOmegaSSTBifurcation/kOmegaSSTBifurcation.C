...
#include "kOmegaSSTBifurcation.H"
...
defineTypeNameAndDebug(kOmegaSSTBifurcation, 0);
addToRunTimeSelectionTable(RASModel, kOmegaSSTBifurcation, dictionary);

// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

tmp<volScalarField> kOmegaSSTBifurcation::F1(const volScalarField& CDkOmega) const
{
...
tmp<volScalarField> kOmegaSSTBifurcation::F2() const
{
...
tmp<volScalarField> kOmegaSSTBifurcation::F3() const
{
...
tmp<volScalarField> kOmegaSSTBifurcation::F23() const
{
...
tmp<volScalarField> kOmegaSSTBifurcation::f() const
{
...
kOmegaSSTBifurcation::kOmegaSSTBifurcation
(
...
tmp<volSymmTensorField> kOmegaSSTBifurcation::R() const
{
...
tmp<volSymmTensorField> kOmegaSSTBifurcation::devReff() const
{
    return tmp<volSymmTensorField>
    (
        new volSymmTensorField
...
tmp<fvVectorMatrix> kOmegaSSTBifurcation::divDevReff(volVectorField& U) const
{
    return
    (
...
tmp<fvVectorMatrix> kOmegaSSTBifurcation::divDevRhoReff
(
...
bool kOmegaSSTBifurcation::read()
{
    if (RASModel::read())
    {
...
void kOmegaSSTBifurcation::correct()
{
    RASModel::correct();
